...
void set_imgui_style() noexcept {
	...
	style.WindowMinSize = ImVec2(34.0f, 34.0f);
	style.WindowTitleAlign = ImVec2(0.15f, 0.5f);
	...
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(.0f, .3f, 1.f, 1.0f);
	...
	style.Colors[ImGuiCol_TabSelected] = ImVec4(0.2000000029802322f, 0.2470588237047195f, 0.2862745225429535f, 1.0f);
	style.Colors[ImGuiCol_TabDimmed] = ImVec4(0.1098039224743843f, 0.1490196138620377f, 0.168627455830574f, 1.0f);
	style.Colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.1098039224743843f, 0.1490196138620377f, 0.168627455830574f, 1.0f);
