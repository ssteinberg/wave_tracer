...
public:
    ...
    /**
     * @brief Writes a block to this film.
     * (not thread safe)
    ...
    /**
     * @brief Colour encoding of the tonemapped developed film.
     */
    [[nodiscard]] virtual bitmap::colour_encoding_t get_colour_encoding_of_developed_tonemapped_film() const noexcept = 0;

    /**
     * @brief Develops the film (no tonemapping). For two-dimensional films.
     * @param samples_per_elements samples per element written (used for scale factor for light images)
     */
    [[nodiscard]] virtual developed_scalar_film_t<2> develop_lin_d2(
            const std::size_t samples_per_element) const = 0;

    /**
     * @brief Develops the film (no tonemapping). For two-dimensional polarimetric films.
     *        Returns an array of 4 developed images, one for each of the Stokes parameters.
     * @param samples_per_elements samples per element written (used for scale factor for light images)
     */
    ...
    /**
     * @brief Develops the film. For two-dimensional films.
     * @param samples_per_elements samples per element written (used for scale factor for light images)
     */
    ...
    /**
     * @brief Develops the film. For two-dimensional polarimetric films.
     *        Returns an array of 4 developed images, one for each of the Stokes parameters.
     * @param samples_per_elements samples per element written (used for scale factor for light images)
     */
...
/**
 * @brief Film storage responsible for accumulating samples and developing the final result.
 */
...
public:
    ...
    /**
     * @brief Splat a value to a light image in this film.
     * (thread safe)
     */
