...
/**
 * @brief 1-dimensional position vector (units of metre)
 */
using pqvec1_t = qvec1<length_t>;
/**
 * @brief 2-dimensional position vector (units of metre)
 */
using pqvec2_t = qvec2<length_t>;
/**
 * @brief 3-dimensional position vector (units of metre)
 */
using pqvec3_t = qvec3<length_t>;
/**
 * @brief 4-dimensional position vector (units of metre)
 */
...
/**
 * @brief A numeric or quantity vector, depending on S
 */
