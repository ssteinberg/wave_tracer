...
/**
 * @brief Propagates and connects a detector and emitter beam. If no shadowing arises, integrates over their mutual phase-space support and returns the weight, otherwise returns 0.
 */
