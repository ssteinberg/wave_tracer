...
/**
 * @brief Attribute that contains a scene element.
 */
...
/**
 * @brief Plain data attribute that contains a scalar, string, vector, matrix, enum or range.
 */
...
/**
 * @brief Container attribute that contains an array or map of attributes.
 */
